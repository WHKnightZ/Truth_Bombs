...
const CoverCard = (props) => {
  ...
  return (
    <div ref={props.cardRef} style={{ ...cardStyle, ...props.cardStyle }} onClick={() => props.onClick(props.i)}>
      <img className="splashStyle1" src={imgSplash} width="336" height="336" alt="splash1" />
      <img className="splashStyle2" src={imgSplash} width="240" height="240" alt="splash2" />
